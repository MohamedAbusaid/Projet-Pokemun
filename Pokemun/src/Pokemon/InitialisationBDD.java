...
public class InitialisationBDD {
    ...
    public static void main(String[] args) {
        try {
            ...
            statement.executeUpdate("DROP TABLE IF EXISTS joueurs"); // Table joueurs
            statement.executeUpdate("DROP TABLE IF EXISTS dresseurs"); // Nettoyage ancienne table si elle existe encore
            ...
            // Table JOUEURS
            statement.executeUpdate("CREATE TABLE joueurs ("
            ...
            // Insertions dans 'joueurs'
            statement.executeUpdate("INSERT INTO joueurs VALUES ('Sacha', '1234', 'DRESSEUR', 47.250221, 5.995451, 'LIBRE', NOW())");
            statement.executeUpdate("INSERT INTO joueurs VALUES ('Drascore', '1234', 'POKEMON', 47.251617, 5.993995, 'LIBRE', NOW())");
            statement.executeUpdate("INSERT INTO joueurs VALUES ('Libegon', '1234', 'POKEMON', 47.250925, 5.992382, 'LIBRE', NOW())");
            
            // Insertions dans 'pokemons' (PNJ)
